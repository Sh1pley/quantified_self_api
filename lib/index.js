...
function addDinner() {
  $('button#blue-oval.dinner').on('click', function() {
    addMeal('#dinner');
  })
}

function addBreakfast() {
  $('button#blue-oval.breakfast').on('click', function() {
    addMeal('#breakfast');
  })
}

function addLunch() {
  $('button#blue-oval.lunch').on('click', function() {
    addMeal('#lunch');
  })
}

function addSnack() {
  $('button#blue-oval.snack').on('click', function() {
    addMeal('#snack');
  })
}
...
function addMeal(buttonType) {
  ...
  Array.from(selectedFoods).forEach(function(foodItem){
    ...
    prependRow((buttonType + '-list'), foodItem.name, foodItem.calories);
  })
}
